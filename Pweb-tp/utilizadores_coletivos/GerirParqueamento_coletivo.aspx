<%@ Page Title="" Language="C#" MasterPageFile="~/utilizadores_coletivos/Cliente_coletivo.master" AutoEventWireup="true" CodeFile="GerirParqueamento_coletivo.aspx.cs" Inherits="utilizadores_unitarios_GerirParqueamento" %>
...
&nbsp;&nbsp;&nbsp;
   ...
   <asp:Panel ID="Panel2" runat="server">
    <div class="form-group">
        ...
        <div class="form-group">
            <asp:Label runat="server"  Font-Bold="true" Font-Underline="true" Font-Size="15">Carro ativos: </asp:Label>
            <div>
        ...
        <div>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Label runat="server" Font-Bold="true" Font-Underline="true" Font-Size="15">Data Inicio: </asp:Label>
            <div>       
                &nbsp;&nbsp;&nbsp;&nbsp;
         ...
         <div>
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Label runat="server"  Font-Bold="true" Font-Underline="true" Font-Size="15">Data Fim: </asp:Label>
            <div>       
                &nbsp;&nbsp;&nbsp;&nbsp;
