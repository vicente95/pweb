<%@ Page Title="" Language="C#" MasterPageFile="~/utilizadores_coletivos/Cliente_coletivo.master" AutoEventWireup="true" CodeFile="inicio_coletivo.aspx.cs" Inherits="utilizadores_unitarios_inicio_unitario" %>
    ...
    <asp:Panel ID="Panel1" runat="server">
        ...
        <div class="form-group">
            <asp:Label runat="server" CssClass="col-md-2 control-label" Text="Nome: " Font-Bold="true" Font-Underline="true" Font-Size="17"></asp:Label>
                ...
                <asp:TextBox ID="Textnome" runat="server" Width="379px" Enabled="False"></asp:TextBox>
