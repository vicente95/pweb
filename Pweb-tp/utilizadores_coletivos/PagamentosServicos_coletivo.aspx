<%@ Page Title="" Language="C#" MasterPageFile="~/utilizadores_coletivos/Cliente_coletivo.master" AutoEventWireup="true" CodeFile="PagamentosServicos_coletivo.aspx.cs" Inherits="utilizadores_unitarios_PagamentosServicos" %>
...
&nbsp;<asp:Button ID="Button1" runat="server" Text="Pesquizar" Width="90px" OnClick="Button1_Click" />
    <br />
    <asp:Label ID="Label3" runat="server" Text="Label">Ver por nome do condutor:</asp:Label>
